   ...
   <form class="well form-horizontal">
      <fieldset>
        ...
        <div class="col-md-8 inputGroupContainer">
           <div class="input-group" >
            <div class="checkbox">
              <label class="col-md-4 control-label"><input type="checkbox" value=""><b>Installation</b></label>
          </div>
        </div>
      </div>
  </div>
      <div class="form-group">
        <div class="col-md-8 inputGroupContainer">
           <div class="input-group">
            <div class="checkbox">
              <label class="col-md-4 control-label"><input type="checkbox" value=""><b>Maintenance</b></label>
          </div>
        </div>
      </div>
  </div>
