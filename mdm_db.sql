...
--
-- Dumping data for table `association_table`
--
...
(1, 'french', 'project umbrella', 'michmich'),
(2, 'english', 'project something', 'quelqu''un');
...
(1, 'Super', 'Oui', 'EN', '', 1, 1, 1, 0, '', '', '', '', '', 1),
(2, 'To be defined', 'To be defined', 'EN', '', 1, 1, 0, 0, '', '', '', '', '', 1);
...
(1, '1', 'VBN', 'M. Dem.', 1, 0, 0, 0, 1, 'peuplé par défaut', 'uh', 'meh', '', '', 'public'),
(2, '2', '', '', 0, 0, 0, 0, 0, 'peuplé par défaut', '', '', '', '', 'public');
...
--
-- Dumping data for table `etcs_subsystem`
--
...
--
-- Dumping data for table `gatc_baseline`
--
...
(2, 'un mec', 'du cul', 'un mec', 'Internal', 'FR', 0),
...
--
ALTER TABLE `gatc_baseline`
  MODIFY `id_baseline` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
